...
const strings = new LocalizedStrings({
  ...
  ruRU: {
    ...
    from: "Начальная дата",
    to: "Конечная дата",
    reportTotal: "Всего заданий",
    reportDone: "Всего сделано заданий",
    reportRejected: "Отклоненных попыток",
    reportAwaiting: "Всего попыток на проверке",
    reportInProgress: "Всего попыток в процессе",
    reportToDo: "Всего не начатых заданий",
    reportNotAssigned: "Всего не назначенных заданий",
    settings: "Настройки",
