...
namespace Enroot.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230425135805_Initial")]
                    ...
                    b.OwnsMany("Enroot.Domain.Tasq.Entities.Assignment", "Assignments", b1 =>
                        {
                            ...
                            b1.OwnsMany("Enroot.Domain.Tasq.Entities.Status", "Statuses", b2 =>
                                {
                                    b2.Property<StatusEnum>("Id")
                                        .HasColumnType("int");
                                    ...
                                    b2.ToTable("Statuses", (string)null);
